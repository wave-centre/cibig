...
<img src="../../assets/img/omics/fastqc_good.PNG" alt="good quality fastqc" width="600">
...
<img src="../../assets/img/omics/multiqc.PNG" alt="bad quality fastqc" width="600">
...
* Leading Trimming: starts trimming from 5' end of the read (starting from left), The trimmer keeps each base until the quality reaches below the threshold
* Trailing Trimming: starts trimming from 3' end of the read (Starting from right)
* Look at inside the read: Scan the read with a 4-base wide sliding window, cutting when the average quality per base drops below 15 (SLIDINGWINDOW:4:15)
